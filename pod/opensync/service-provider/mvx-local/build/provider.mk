# mvx-opensync lab cloud: local-noc on the lab VM's WAN segment (plain-TCP
...
export BACKHAUL_SSID := mvx-opensync-bhaul
export BACKHAUL_PASS := mvx-opensync-bhaul-psk
# what the OVSDB bootstrap turns into Wifi_Credential_Config rows ("ssid;psk")
PROVIDER_BACKHAUL_CREDS := "mvx-opensync-bhaul;mvx-opensync-bhaul-psk"
endif
