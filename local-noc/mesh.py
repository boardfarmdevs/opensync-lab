...
def add_args(ap):
    ...
    g.add_argument("--mesh-bhaul-ssid", default="mvx-opensync-bhaul")
    g.add_argument("--mesh-bhaul-psk", default="mvx-opensync-bhaul-psk")
    g.add_argument("--mesh-home-ssid", default="mvx-opensync-home")
    g.add_argument("--mesh-home-psk", default="mvx-opensync-home-psk")
